#!/bin/bash
#SBATCH --job-name=PANC1_Parental_custom_lambda_notry_compass_job
#SBATCH --output=PANC1_Parental_custom_lambda_notry_compass_job.out
...
compass --data-mtx /home/dzhang/Compass_Results/PANC_scRNAseq/compass_files/PANC1/PAR/PANC1_matrix.mtx                     /home/dzhang/Compass_Results/PANC_scRNAseq/compass_files/PANC1/PAR/PANC1_genes.tsv                     /home/dzhang/Compass_Results/PANC_scRNAseq/compass_files/PANC1/PAR/PANC1_barcodes.tsv                     --model HumanGEM --num-processes 15                     --custom /home/dzhang/Compass_Integration/model_xml/0_1_models/ASPC1_PAR_0_75.xml                     --latent-space /home/dzhang/Compass_Results/PANC_scRNAseq/compass_files/PANC1/PAR/PANC1_umap.tsv                     --species homo_sapiens --lambda 0.25 --calc-metabolites                     --output-dir /home/dzhang/Compass_Results/PANC_scRNAseq/compass_results/ASPC1_models/PANC1/PAR/                     --temp-dir /home/dzhang/Compass_Results/PANC_scRNAseq/compass_results/ASPC1_models/PANC1/PAR/tmpPANC1
