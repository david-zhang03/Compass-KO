#!/bin/bash
#SBATCH --job-name=ASPC1_Parental_custom_no_lambda_no_try_compass_job
#SBATCH --output=ASPC1_Parental_custom_no_lambda_no_try_compass_job.out
