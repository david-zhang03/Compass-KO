#!/bin/bash
#SBATCH --job-name=MIA_Parental_custom_no_lambda_no_try_compass_job
#SBATCH --output=MIA_Parental_custom_no_lambda_no_try_compass_job.out
